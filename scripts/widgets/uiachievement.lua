...
local uiachievement = Class(Widget, function(self, owner)
	...
	--self.mainui.infobutton.cat4.label:SetString(STRINGS.GUI["like"])
	self.mainui.infobutton.cat4.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat4.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat4.label:SetMultilineTruncatedString(STRINGS.GUI["like"], 2, 120, 50, "", true)
	...
	--self.mainui.infobutton.cat5.label:SetString(STRINGS.GUI["pain"])
	self.mainui.infobutton.cat5.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat5.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat5.label:SetMultilineTruncatedString(STRINGS.GUI["pain"], 2, 120, 50, "", true)
	...
	--self.mainui.infobutton.cat6.label:SetString(STRINGS.GUI["fight"])
	self.mainui.infobutton.cat6.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat6.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat6.label:SetMultilineTruncatedString(STRINGS.GUI["fight"], 2, 120, 50, "", true)
	...
	--self.mainui.infobutton.cat7.label:SetString(STRINGS.GUI["hunt"])
	self.mainui.infobutton.cat7.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat7.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat7.label:SetMultilineTruncatedString(STRINGS.GUI["hunt"], 2, 120, 50, "", true)
	...
	--self.mainui.infobutton.cat8.label:SetString(STRINGS.GUI["boss"])
	self.mainui.infobutton.cat8.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat8.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat8.label:SetMultilineTruncatedString(STRINGS.GUI["boss"], 2, 120, 50, "", true)
	...
	--self.mainui.infobutton.cat9.label:SetString(STRINGS.GUI["misc"])
	self.mainui.infobutton.cat9.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat9.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat9.label:SetMultilineTruncatedString(STRINGS.GUI["misc"], 2, 120, 50, "", true)
	...
	--self.mainui.infobutton.cat10.label:SetString(STRINGS.GUI["emer"])
	self.mainui.infobutton.cat10.label:SetScale(0.9,0.9,1)
	self.mainui.infobutton.cat10.label:SetColour(0,0,0,1)
	self.mainui.infobutton.cat10.label:SetMultilineTruncatedString(STRINGS.GUI["emer"], 2, 120, 50, "", true)	
	...
	self.mainui.levelbg.levelupbuttons.plushunger:SetPosition(0, -115, 0)
	...
	self.mainui.levelbg.levelupbuttons.plussanity:SetPosition(0, -160, 0)
	...
	self.mainui.levelbg.levelupbuttons.plushealth:SetPosition(0, -200, 0)
...
function uiachievement:loadlist()
	self.achivlist = {
		...
		{
			name = "eatrata",
			check = self.owner.checkeatrata:value(),
			current = self.owner.currenteatrata:value(),
		},	
		{
			name = "eatmole",
		...
		{
			name = "eatwaffle",
			check = self.owner.checkeatwaffle:value(),
			current = self.owner.currenteatwaffle:value(),
		},			
		{
			name = "eatturkey",
		...
		{
			name = "shroom",
			check = self.owner.checkshroom:value(),
			current = nil,
		},	
		{
			name = "messiah",
		...
		{
			name = "fortress",
			check = self.owner.checkfortress:value(),
			current = self.owner.currentattackeddamage:value(),
		},
		{
			name = "dmgnodmg",
		...
		{
			name = "sheep",
			check = self.owner.checksheep:value(),
			current = nil,
		},
		{
			name = "whipit",
			check = self.owner.checkwhipit:value(),
			current = self.owner.currentwhipit:value(),
		},
		{
			name = "tentacruel",
			check = self.owner.checktentacruel:value(),
			current = self.owner.currenttentacruelamount:value(),
		},
		{
			name = "whack",
			check = self.owner.checkwhack:value(),
			current = self.owner.currentwhack:value(),
		},		
		{
			name = "angry",
		...
		{
			name = "bullseye",
			check = self.owner.checkbullseye:value(),
			current = self.owner.currentbullseye:value(),
		},
		--Hunt
		{
			name = "slurtle",
		...
		{
			name = "tentacool",
			check = self.owner.checktentacool:value(),
			current = self.owner.currenttentacoolamount:value(),
		},
		{
			name = "mossling",
		...
		{
			name = "koalefant",
			check = self.owner.checkkoalefant:value(),
			current = self.owner.currentkoalefant:value(),
		},
		{
			name = "goatperd",
		...
		{
			name = "crabking",
			check = self.owner.checkcrabking:value(),
			current = nil,
		},
		{
			name = "rook",
		...
		{
			name = "eatefc",
			check = self.owner.checkeatefc:value(),
			current = self.owner.currenteatefc:value(),
		},
		{
			name = "goldcoin",
			check = self.owner.checkgoldcoin:value(),
			current = self.owner.currentgoldcoin:value(),
		},					
		{
			name = "eathorn",
			check = self.owner.checkeathorn:value(),
			current = self.owner.currenteathorn:value(),
		},
		{
			name = "baronsuit",
			check = self.owner.checkbaronsuit:value(),
			current = self.owner.currentbaronsuit:value(),
		},						
		{
			name = "eateye",
			check = self.owner.checkeateye:value(),
			current = self.owner.currenteateye:value(),
		},
		{
			name = "eatgold",
			check = self.owner.checkeatgold:value(),
			current = self.owner.currenteatgold:value(),
		},	
		--[[{
			name = "luck",
...
function uiachievement:loadcoinlist()
	self.coinlist = {
		...
		{
			name = "artsdegree",
			current = self.owner.currentartsdegree:value(),
		},
		{
			name = "ancientstation",
